...
class PromptOptimizationFilter:
    ...
    def _optimize_message(
        self, message: str, params: dict[str, float], context: dict[str, Any]
    ) -> str:
    ...
    def _filter_payload(
        self, payload: dict[str, Any] | None, params: dict[str, float]
    ) -> dict[str, Any] | None:
    ...
    def add_predictive_suggestions(
        self, response: AgentResponse, predictions: list[dict[str, Any]]
    ) -> AgentResponse:
